						...
						<?php if($outbox_list): ?>		
							...
							<?php $message_recipient = $this->Sipuma_model->message_recipient($outbox->message_id); ?>	
									<tr class="odd">
										...
										<td>
											<a href="<?php echo base_url().'admin/message_detail/'.$outbox->message_id; ?>"><?php echo tgl_indo($outbox->message_date); ?></a>
										</td>
										<td>
									...
									<?php endif; ?>
										...
										<td>
											<a href="#" onClick="confirmation('<?php echo base_url().'admin/message_delete/'.$outbox->message_id; ?>')">[Hapus]</a>
										</td>
									</tr>				
							<?php endforeach; ?>
								</tbody>
