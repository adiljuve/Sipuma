				...
				<?php if($paper_detail_review): ?>	
					...
					<div class="block">
						...
						<?php if($paper_detail_review->file_name != ''): ?>
							<li><a href="<?php echo base_url().'mahasiswa/file/'.$paper_detail_review->paper_id; ?>" onclick="$(this).modal({width:900, height:500}).open(); return false;"><?php echo $paper_detail_review->file_name; ?></a></li>
						<?php else: ?>
							<li>-</li>
						<?php endif; ?>
						</ul>
					...
					<?php endif; ?>
					<p><a href="<?php echo base_url().'mahasiswa/paper_list';?>">[Kembali]</a></p>
				<?php else: ?>
