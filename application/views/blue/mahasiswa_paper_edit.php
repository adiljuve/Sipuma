				<div class="block">
					...
					<div class="block">
						...
						<h5>File Lama:</h5>
						<?php $file_revision = $this->Sipuma_model->file_revision($paper_detail_edit->paper_id); ?>
						<ul class="file">
					...
					<?php $check_edit = $this->Sipuma_model->paper_edit_check($paper_detail_edit->paper_id); ?>
					<?php if($check_edit != 0): ?>
