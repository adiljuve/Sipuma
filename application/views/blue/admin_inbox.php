						...
						<?php if($inbox_list): ?>
							...
							<?php foreach($inbox_list as $inbox): ?>								
									<tr class="odd">
										...
										<td>
											<a href="<?php echo base_url().'admin/message_read/'.$inbox->message_status.'/'.$inbox->message_id; ?>"><?php echo $inbox->full_name.' ('.$inbox->user_id.')'; ?></a>
										</td>
										<td>
										...
										<td>
											<a href="#" onClick="confirmation('<?php echo base_url().'admin/message_inbox_delete/'.$inbox->message_id; ?>')">[Hapus]</a>
										</td>
									</tr>
							<?php endforeach; ?>
								</tbody>
