...
<script type="text/javascript">
	...
	if(browser_info.acrobat == "installed"){
		...
		window.location.href = "<?php echo base_url().'file/preview/'.$file_id; ?>";
	}else{
		document.write('<p>Browser yang Anda gunakan tidak mendukung file dokumen PDF. Silakan unduh file <a href="<?php echo base_url().'file/download/'.$file_id; ?>">disini</a></p>');
	}
</script>
	</div>
</body>
