						...
						<?php if($user_list): ?>	
							...
							<?php foreach($user_list as $user): ?>	
									<tr class="odd">
										...
										<td><a href="<?php echo base_url().'admin/user_type/'.$user->user_type; ?>">
										<?php if($user->user_type == 'M'): ?>
										Mahasiswa
										<?php elseif($user->user_type == 'D'): ?>
										Dosen
										<?php endif; ?>
										</a></td>
						...
						<form name="registration" id="registration" action="" method="post" onSubmit="return registration_check(registration)">
							<fieldset>
								...
								<p>
									...
									<input type="text" name="phone_number" id="phone_number" maxlength="20" onBlur="white_space(phone_number)" />
								</p>
								<p>
									<label>Website: </label>
