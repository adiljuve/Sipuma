				<div class="block">
					...
					<ul>
						...
						<li><a href="<?php echo base_url().'mahasiswa/journal_detail/'.$journal_member->path; ?>"><?php echo $journal_member->journal_name; ?></a></li>
						<?php endforeach; ?>
					</ul>
					<?php endif; ?>
					<?php if($user_other_detail->user_type == 'M'): ?>
					...
					<ol>
						<?php foreach($paper_published_user as $paper): ?>
							<li>
								<a href="<?php echo base_url().'mahasiswa/paper/'.$paper->paper_id; ?>"><?php echo $paper->title; ?></a>
