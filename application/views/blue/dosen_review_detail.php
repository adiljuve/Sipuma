				...
				<?php if($paper_detail_review): ?>	
					...
					<div class="first article">
						<?php foreach($paper_review as $review): ?>							
							<p class="meta"><b><i><a href="<?php echo base_url().'dosen/user_detail/'.$review->user_id; ?>"><?php echo $review->full_name; ?></a>, <?php echo tgl_indo($review->review_date); ?></i></b>  <?php if($review->user_id == $this->session->userdata('user_id')): ?><a href="#" onClick="confirmation('<?php echo base_url().'dosen/review_delete/'.$review->review_id; ?>')">[Hapus]</a><?php endif; ?></p>
					...
					<?php endif; ?>
					<p><a href="<?php echo base_url().'dosen/review';?>">[Kembali]</a></p>
				<?php else: ?>
